...
/*
 * Setup for the Chord Overseer.
 */

/*
 * Board identifier.
 */
#define BOARD_CHORD_OVERSEER_STM32_F103
#define BOARD_NAME              "Chord Overseer"
...
#define GPIOC_OSD32_OUT         15
#define GPIOA_USART2_CTS        0 
#define GPIOA_USART2_RTS        1 
...
#define GPIOB_I2C1_SMBA         5 
#define GPIOB_I2C1_SCL          6 
#define GPIOB_I2C1_SDA          7 
#define GPIOB_BOOT0_BUTTON      8 
 ...
 * PB0     - Push Pull output  (matrix).
 * PB1     - Push Pull output  (matrix).
 * PB3     - Push Pull output  (matrix).
 * PB4     - Push Pull output  (matrix).
 * PB10    - Push Pull output  (LED).
 * PB11    - Push Pull output  (LED).
 */
#define VAL_GPIOBCRL            0x88833833      /*  PB7...PB0 */
#define VAL_GPIOBCRH            0x88882288      /* PB15...PB8 */
 ...
 */
#define usb_lld_connect_bus(usbp) palSetPadMode(GPIOA, GPIOA_USBDP, PAL_MODE_INPUT);


/*
 * USB bus de-activation macro, required by the USB driver.
 */
#define usb_lld_disconnect_bus(usbp) palSetPadMode(GPIOA, GPIOA_USBDP, PAL_MODE_OUTPUT_PUSHPULL); palClearPad(GPIOA, GPIOA_USBDP);
