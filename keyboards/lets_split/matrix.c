...
void slave_process_cmd(uint8_t cmd)
{
    switch(cmd)
    {
        ...
        case CMD_BREATHING_TOGGLE:
            breathing_toggle();
            break;
        case CMD_BREATHING_PERIOD_DEFAULT:
            breathing_period_default();
            break;
        case CMD_BREATHING_INTENSITY_DEFAULT:
            breathing_intensity_default();
            break;
        case CMD_BREATHING_PERIOD_SET_0 ... CMD_BREATHING_PERIOD_SET_15:
            breathing_period_set(cmd - CMD_BREATHING_PERIOD_SET_0);
            break;
        case CMD_BREATHING_PERIOD_INC:
            breathing_period_inc();
            break;
        case CMD_BREATHING_PERIOD_DEC:
